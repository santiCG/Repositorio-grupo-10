...
var usuario_enfermeria

function usuario_normal() {

    usuario_enfermeria = false
    console.log(usuario_enfermeria)
}

function usuario_salud() {

    usuario_enfermeria = true
    console.log(usuario_enfermeria)
}
...
function busquedaMedicamentoAvanzado() {
